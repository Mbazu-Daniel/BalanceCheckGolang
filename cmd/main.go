...
func main() {
	...
	auth := getAccountAuth(client, "ca6f35febdaa062f1423852622dcb0953a2df9c058413c15b21570e172838b91")
...
// 2. Connect any account tom make the transaction
